! function(d) {
    ...
    var a = function(h, g) {
        ...
        this.setDatesDisabled(g.datesDisabled || this.element.data("date-disabled"));
    ...
    a.prototype = {
        ...
        setDatesDisabled: function(g) {            
            this.datesDisabled = g || [];                        
            this.datesDisabled = d.map(this.datesDisabled, function(h) {
                var dt = new Date(h);     
                dt = new Date(dt.getTime() - (dt.getTimezoneOffset() * 60000));      
                //console.log(dt.getUTCMonth()+"/"+dt.getUTCDate()+"/"+dt.getUTCFullYear());     
                return dt.valueOf();
            });            
            this.update();
            this.updateNavArrows()
        ...
        fill: function() {
            ...
            while (B.valueOf() < g) {
                ...
                //console.log(B.getUTCMonth()+"/"+B.getUTCDate()+"/"+B.getUTCFullYear());  
                if (B.valueOf() < this.startDate || B.valueOf() > this.endDate || d.inArray(B.valueOf(), this.datesDisabled) !== -1 || d.inArray(B.getUTCDay(), this.daysOfWeekDisabled) !== -1) {
                    r += " disabled"
                }
                //alert(B.valueOf());
